...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x40f1d8)) ;
...
extern "C" {
	...
	extern void subprog_m_4baa8978_556ead11_2240(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 423816, 168, 276160) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_4baa8978_556ead11_2240), IP) ;
